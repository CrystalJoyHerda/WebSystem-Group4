...
$roleLabel = 'Guest';
if ($role === 'manager') $roleLabel = 'Warehouse Manager B';
elseif ($role === 'staff') $roleLabel = 'Warehouse Staff B';
...
<aside class="sidebar">
    <div class="profile">
        ...
        <div style="text-align:center;font-weight:600"><?= esc(session() ? session()->get('name') ?? $roleLabel : $roleLabel) ?></div>
        <div style="text-align:center; font-size:13px; color:#333;"><?= esc($roleLabel) ?></div>
    </div>
    <nav class="nav flex-column">
        <?php if ($role === 'manager'): ?>
            <a class="nav-link" href="<?= site_url('dashboard/warehouse2/manager') ?>">Dashboard</a>
        ...
        <?php elseif ($role === 'staff'): ?>
            <a class="nav-link" href="<?= site_url('dashboard/warehouse2/staff') ?>">Dashboard</a>
            <a class="nav-link" href="<?= site_url('dashboard/warehouse2/staff/barcode') ?>">Barcode Scanning</a>
            <a class="nav-link" href="<?= site_url('inventory') ?>">Inventory</a>
