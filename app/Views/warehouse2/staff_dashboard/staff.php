...
<head>
    ...
    <title>Warehouse Staff Dashboard - Warehouse 2</title>
    ...
    <style>
        ...
        @media (max-width: 991px) { .sidebar { position: relative; width: 100%; } .main { margin-left: 0; padding: 16px; } }
    </style>
</head>
<body>
    <div class="app-shell">
        ...
        <main class="main">
            ...
            <div class="page-title">Warehouse DASHBOARD (Warehouse 2)</div>
