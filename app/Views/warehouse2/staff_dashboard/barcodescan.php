...
<head>
    ...
    <title>Barcode Scanning - Warehouse 2</title>
    ...
    <style>
        ...
        @media (max-width: 991px) { .sidebar { position: relative; height: auto; width: 100%; } .main { margin-left: 0; padding: 16px; } .scan-container { flex-direction: column; } .scan-left { flex: 1; } }
    </style>
</head>
<body>
<div class="app-shell">
    <?= view('warehouse2/partials/sidebar') ?>
    ...
    <main class="main">
        ...
        <h2 class="page-title">BARCODE SCANNING (Warehouse 2)</h2>
