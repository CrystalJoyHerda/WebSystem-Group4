    ...
    <div class="app-shell">
        ...
        <main class="main">
            ...
            <div class="page-title d-flex align-items-center justify-content-between">
                <div>Warehouse DASHBOARD (Warehouse 2)</div>
                <?php if (session() && session()->get('role') === 'manager'): ?>
                    <div>
            ...
            <!-- Create Outbound Modal (shared include) -->
            <?php if (session() && session()->get('role') === 'manager'): ?>
...
?>
                <div class="col-md-4">
                    <a class="stat-link" href="<?= site_url('dashboard/warehouse2/manager/stockmovement') ?>">
